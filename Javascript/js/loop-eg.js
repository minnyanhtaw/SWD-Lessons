...
//   };
// };
// console.table(oddEven(points));

// const arraySlice = function (array, length) {
//   const result = [];
//   for (let i in array) {
//     if (i == length) break;
//     result[i] = array[i];
...
//   return result;
// };
// console.log(arraySlice(points,2));

// const arraySlice = function (array, startIndex, length) {
//   const result = [];
//   let resultIndex = 0;
...
// };
// console.log(points);
// console.log(arraySlice(points,5,2));
...
// const arrayFilter = function (array, fun) {
//   const result = [];
//   let resultIndex = 0;
...
// console.log("over all : " + overAllResult);
// console.table(allStudentsMark);
// console.log(marks);
...
const cheseBoard = function (row, col) {
  let result = "";
  for (let i = 0; i <= row; i++) {
    let cheseCol = "";
    for (let j = 0; j <= col; j++) {

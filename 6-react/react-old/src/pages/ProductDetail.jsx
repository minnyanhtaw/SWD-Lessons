...
const ProductDetail = () => {
  ...
  return (
    <Container>
      ...
      <div className="grid grid-cols-2 py-5 px-20 border-2 border-zinc-700 items-start">
        ...
        <div className=" col-span-1 flex flex-col gap-5 items-start">
          ...
          <div className="flex justify-between w-full items-center">
            ...
            {carts.find((cart) => cart.id === currentProduct.id) ? (
              <button className="border border-black px-4 py-2 bg-black opacity-70 text-white">Added</button>
            ) : (
